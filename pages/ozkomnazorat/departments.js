...
const page = () => {
  ...
  return (
    <div>
      <Head>
        <title>{t("page-titles.ozcom.departments")}</title>
        <meta name="viewport" content="initial-scale=1.0, width=device-width" />
        <meta name="description" content={t("page-titles.ozcom.departments")} />
        <meta
          property="og:title"
          content={t("page-titles.ozcom.departments")}
          key="title"
        />
        <meta name="title" content={t("page-titles.ozcom.departments")} />
        <meta property="og:type" content="website" />
        <meta
          property="og:url"
          content="https://gis.uz/ozkomnazorat/departments"
        />
                ...
                <div className="flex flex-col lg:flex-row p-[24px] bg-[#3A2F7D]  hover:bg-[#312E6B]">
                  ...
                  <div className="basis-4/5 flex flex-col">
                    <div className="basis-6/12">
                      <p className="text-white text-start xl:text-left font-montserrat font-medium text-[1.12em] mt-[10px] lg:mt-[0] mb-[8px]">
                        {l.position}
                      </p>
                      <p className="font-semibold text-start text-[#A2A0B3] xl:text-left font-inter text-[1.25em] h-[90px] max-h-[35px] text-text_secondary mb-[8px] lg:mb-[0">
