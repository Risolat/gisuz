        ...
        <div className="flex flex-row items-start py-[40px]">
          <div className="basis-3/4">
            ...
            <div className="flex mb-[20px]">
              <div className="flex flex-wrap justify-between mr-[20px] cursor-pointer relative">
                {videos1.map((v) => (
                  <div key={v.id}>
                    <a
                    ...
                    >
                      ...
                      <Image
                        src={play}
                        className="absolute top-[calc(50%-30px)] left-[calc(50%-26px)]  w-[60px] h-[60px]"
                        alt="photo"
                        width={60}
                        height={60}
                      />
            ...
            <div
              ...
              className="flex items-center flex-wrap mr-[20px]"
            >
              {videos3.map((v, index) => (
