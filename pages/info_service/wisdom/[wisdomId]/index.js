          ...
          <div className="basis-3/4">
            ...
            <div className="flex items-center justify-between pr-[20px] pb-[10px]">
              ...
              <div className="flex items-center">
                <Link
                  target="_blank"
                  href={`${`https://www.facebook.com/sharer/sharer.php?u=${`http://newgis.technocorp.uz/${locale}/wisdom/info_service/${query}&text=${wisdom.title}`}`}`}
                >
                  <Icon
                ...
                <Link
                  href={`${`http://telegram.me/share/url?url=http://newgis.technocorp.uz/${locale}/wisdom/info_service/${query}&text=${wisdom.title}`}`}
                  className="mx-[10px]"
                  target="_blank"
                >
                  <Icon
...
export async function getServerSideProps(context) {
  ...
  const query = context.query.wisdomId;
  console.log(query, "qwertyuiojhgfdfvbnbv");
